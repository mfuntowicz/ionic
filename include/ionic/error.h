...
enum ionic_error_kind {
    ...
    IONIC_ERROR_UNSUPPORTED_TOPOLOGY,
    IONIC_ERROR_INVALID_VALUE,
    IONIC_ERROR_ALLOCATION_FAILED,
    IONIC_ERROR_ALLOCATION_NOT_ALIGNED,
    IONIC_ERROR_IOENGINE_INITIALIZATION_FAILED,
    IONIC_ERROR_IOENGINE_INVALID_PARAMETER,
...
#define IONIC_CUDA_ERR_WITH_MSG(err, msg) (struct ionic_error){ .kind = IONIC_ERROR_CUDA, .res = (err), .what = (msg) }
